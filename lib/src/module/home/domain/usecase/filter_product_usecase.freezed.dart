...
part of 'filter_product_usecase.dart';
...
class _$FilterParamsImpl implements _FilterParams {
  const _$FilterParamsImpl({this.title = ""});
  ...
  @override
  String toString() {
    return 'FilterParams(title: $title)';
  }
...
abstract class _FilterParams implements FilterParams {
  const factory _FilterParams({final String title}) = _$FilterParamsImpl;
