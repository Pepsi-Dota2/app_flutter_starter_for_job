...
class _$HistoryModelImpl implements _HistoryModel {
  const _$HistoryModelImpl({this.doc_no = ""});
  ...
  @override
  String toString() {
    return 'HistoryModel(doc_no: $doc_no)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, doc_no);
...
abstract class _HistoryModel implements HistoryModel {
  const factory _HistoryModel({final String doc_no}) = _$HistoryModelImpl;
